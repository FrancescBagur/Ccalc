...
imatge = Image('/Ccalc/PoinTransform/PoinTransform/bin/Debug/autotrace-0.31.1/'+sys.argv[1])
...
#la guardo
imgInver.save('/Ccalc/PoinTransform/PoinTransform/bin/Debug/autotrace-0.31.1/'+ sys.argv[1])
